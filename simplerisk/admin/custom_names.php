              ...
              <div class="jumbotron">
                <form name="mitigation_effort" method="post" action="">
                  <p>
                    ...
                    <?php 
                      echo $escaper->escapeHtml($lang['Change']); 
                      create_dropdown("mitigation_effort"); 
                      echo $escaper->escapeHtml($lang['to']);
                    ?>
                    <input name="new_name" type="text" size="20" />&nbsp;&nbsp;<input type="submit" value="<?php echo $escaper->escapeHtml($lang['Update']); ?>" name="update_mitigation_effort" />
                  </p>
                </form>
              </div>
            </div>
